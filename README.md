...
<ul>
<li><code>key="{account key}"</code></li>
...
<p>You can find the <code>{account key}</code> on <a href="https://www.screenshotmachine.com/account.php">your Screenshot Machine account/settings page</a>.</p>
